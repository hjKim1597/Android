package com.example.androidbasic.AndroidBasic2
...
//                .show()
        ...
        /* nameEdit.addTextChangedListener {
             ...
             val color1 = ContextCompat.getColor(this, R.color.myColor2)
             val color2 = ContextCompat.getColor(this, R.color.myColor1)
        ...
        birthBtn.setOnClickListener {
            ...
            val dialog = DatePickerDialog(
                ...
                { view, year, month, dayOfMonth ->
                    ...
                    val nowMillis = System.currentTimeMillis() // 1970~ 지금까지의 밀리초를

                    val sdf = SimpleDateFormat("yyyy-MM-dd") // 날짜 형식
                    val date = sdf.parse(selected)
                    val millis = date.time //밀리초를 구함

                    val result = (nowMillis - millis) / 1000 / 60 / 60 / 24 / 365
            ...
            dialog.datePicker.maxDate = System.currentTimeMillis() // 현재 날짜 다음 값ㅇ르 선택하지 못하게 함
